...
# 修改设备名称
[ -f package/base-files/files/bin/config_generate ] && sed -i 's/OpenWrt/JDCloud/g' package/base-files/files/bin/config_generate
[ -f package/base-files/files/bin/config_generate ] && sed -i 's/LibWrt/JDCloud/g' package/base-files/files/bin/config_generate
[ -f package/base-files/luci2/bin/config_generate ] && sed -i 's/LEDE/JDCloud/g' package/base-files/luci2/bin/config_generate
...
# # 设置wifi加密方式为psk2+ccmp,wifi密码为 39393939
