...
# # 设置wifi名称,加密方式为psk2+ccmp,wifi密码为 39393939
[ -f package/kernel/mac80211/files/lib/wifi/mac80211.sh ] && sed -i 's/LEDE/super/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
[ -f package/kernel/mac80211/files/lib/wifi/mac80211.sh ] && sed -i 's/OpenWrt/super/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
